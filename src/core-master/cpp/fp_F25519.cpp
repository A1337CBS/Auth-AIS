...
/* So when multiplying two numbers, their product *must* be less than MODBITS_F25519+BASEBITS_B256_56*NLEN_B256_56 */
/* Results *may* be one bit bigger than MODBITS_F25519 */
...
void F25519::FP_invsqrt(FP *r,FP *x)
{
#if MODTYPE_F25519==PSEUDO_MERSENNE  || MODTYPE_F25519==GENERALISED_MERSENNE
    FP_fpow(r, x);  
#else
