...
#define MODBITS_F384PM MBITS_F384PM
#define TBITS_F384PM (MBITS_F384PM%BASEBITS_B384_56)              /**< Number of active bits in top word */
#define TMASK_F384PM (((chunk)1<<TBITS_F384PM)-1)             /**< Mask for active bits in top word */
#define FEXCESS_F384PM (((sign32)1<<MAXXES_F384PM)-1)		    /**< 2^(BASEBITS*NLEN-MODBITS) - normalised BIG can be multiplied by less than this before reduction */
#define OMASK_F384PM (-((chunk)(1)<<TBITS_F384PM))            /**<  for masking out overflow bits */
