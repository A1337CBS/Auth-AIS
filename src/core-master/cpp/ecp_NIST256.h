...
//    int inf; /**< Infinity Flag - not needed for Edwards representation */
    ...
    NIST256::FP x; /**< x-coordinate of point */
#if CURVETYPE_NIST256!=MONTGOMERY
    NIST256::FP y; /**< y-coordinate of point. Not needed for Montgomery representation */
#endif
    NIST256::FP z;/**< z-coordinate of point */
} ECP;
 ...
 */
extern void ECP_rhs(NIST256::FP *r, NIST256::FP *x);
