...
#define TBITS_NIST256 (MBITS_NIST256%BASEBITS_B256_56)              /**< Number of active bits in top word */
#define TMASK_NIST256 (((chunk)1<<TBITS_NIST256)-1)             /**< Mask for active bits in top word */
#define FEXCESS_NIST256 (((sign32)1<<MAXXES_NIST256)-1)		    /**< 2^(BASEBITS*NLEN-MODBITS) - normalised BIG can be multiplied by less than this before reduction */
