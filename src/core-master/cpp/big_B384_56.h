...
#ifndef BIG_B384_56_H
#define BIG_B384_56_H
...
#define BIGBITS_B384_56 (8*MODBYTES_B384_56)
#define NLEN_B384_56 (1+((8*MODBYTES_B384_56-1)/BASEBITS_B384_56))
#define DNLEN_B384_56 2*NLEN_B384_56
#define BMASK_B384_56 (((chunk)1<<BASEBITS_B384_56)-1) /**< Mask = 2^BASEBITS-1 */
#define NEXCESS_B384_56 (1<<(CHUNK-BASEBITS_B384_56-1))           /**< 2^(CHUNK-BASEBITS-1) - digit cannot be multiplied by more than this before normalisation */

#define HBITS_B384_56 (BASEBITS_B384_56/2)      /**< Number of bits in number base divided by 2 */
#define HMASK_B384_56 (((chunk)1<<HBITS_B384_56)-1)    /**< Mask = 2^HBITS-1 */

//#define DEBUG_NORM

#ifdef DEBUG_NORM  /* Add an extra location to track chunk extension */
#define MPV_B384_56 NLEN_B384_56
#define MNV_B384_56 (NLEN_B384_56+1)
#define DMPV_B384_56 DNLEN_B384_56
#define DMNV_B384_56 (DNLEN_B384_56+1)
...
#ifdef DEBUG_NORM
typedef chunk BIG[NLEN_B384_56 + 2]; /**< Define type BIG as array of chunks */
typedef chunk DBIG[DNLEN_B384_56 + 2]; /**< Define type DBIG as array of chunks */
#else
typedef chunk BIG[NLEN_B384_56];     /**< Define type BIG as array of chunks */
typedef chunk DBIG[DNLEN_B384_56];   /**< Define type DBIG as array of chunks */
#endif
...
inline chunk muladd(chunk x, chunk y, chunk c, chunk *r)
{
    ...
    *r = (chunk)prod & BMASK_B384_56;
    return (chunk)(prod >> BASEBITS_B384_56);
}
...
inline chunk muladd(chunk x, chunk y, chunk c, chunk *r)
{
    ...
    top = x1 * y1;
    mid = x0 * y1 + x1 * y0;
    x0 = mid & HMASK_B384_56;
    x1 = (mid >> HBITS_B384_56);
    bot += x0 << HBITS_B384_56;
    bot += *r;
    bot += c;

    top += x1;
    carry = bot >> BASEBITS_B384_56;
    bot &= BMASK_B384_56;
    top += carry;
