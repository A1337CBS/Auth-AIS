...
#define MODBITS_NIST521 MBITS_NIST521
#define TBITS_NIST521 (MBITS_NIST521%BASEBITS_B528_60)              /**< Number of active bits in top word */
#define TMASK_NIST521 (((chunk)1<<TBITS_NIST521)-1)             /**< Mask for active bits in top word */
#define FEXCESS_NIST521 (((sign32)1<<MAXXES_NIST521)-1)		    /**< 2^(BASEBITS*NLEN-MODBITS) - normalised BIG can be multiplied by less than this before reduction */
#define OMASK_NIST521 (-((chunk)(1)<<TBITS_NIST521))            /**<  for masking out overflow bits */
...
typedef struct
{
    B528_60::BIG g;	/**< Big representation of field element */
    sign32 XES;	/**< Excess */
} FP;

/* Field Params - see rom.c */
extern const B528_60::BIG Modulus;	/**< Actual Modulus set in rom_field*.c */
extern const B528_60::BIG ROI;	    /**< Root of Unity  set in rom_field*.c */
extern const B528_60::BIG R2modp;	/**< Montgomery constant */
...
extern const B528_60::BIG Fra; /**< real part of Pairing-friendly curve Frobenius Constant */
extern const B528_60::BIG Frb; /**< imaginary part of Pairing-friendly curve Frobenius Constant */
 ...
 */
extern void FP_rcopy(FP *y, const B528_60::BIG x);
 ...
 */
extern void FP_mod(B528_60::BIG r, B528_60::DBIG d);

#ifdef FUSED_MODMUL
extern void FP_modmul(B528_60::BIG, B528_60::BIG, B528_60::BIG);
#endif
 ...
 */
extern void FP_pow(FP *x, FP *y, B528_60::BIG z);
