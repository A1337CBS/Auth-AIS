...
#define MODBITS_F512PM MBITS_F512PM
#define TBITS_F512PM (MBITS_F512PM%BASEBITS_B512_56)              /**< Number of active bits in top word */
#define TMASK_F512PM (((chunk)1<<TBITS_F512PM)-1)             /**< Mask for active bits in top word */
#define FEXCESS_F512PM (((sign32)1<<MAXXES_F512PM)-1)		    /**< 2^(BASEBITS*NLEN-MODBITS) - normalised BIG can be multiplied by less than this before reduction */
#define OMASK_F512PM (-((chunk)(1)<<TBITS_F512PM))            /**<  for masking out overflow bits */
...
typedef struct
{
    B512_56::BIG g;	/**< Big representation of field element */
    sign32 XES;	/**< Excess */
} FP;

/* Field Params - see rom.c */
extern const B512_56::BIG Modulus;	/**< Actual Modulus set in rom_field*.c */
extern const B512_56::BIG ROI;	    /**< Root of Unity  set in rom_field*.c */
extern const B512_56::BIG R2modp;	/**< Montgomery constant */
...
extern const B512_56::BIG Fra; /**< real part of Pairing-friendly curve Frobenius Constant */
extern const B512_56::BIG Frb; /**< imaginary part of Pairing-friendly curve Frobenius Constant */
 ...
 */
extern void FP_rcopy(FP *y, const B512_56::BIG x);
 ...
 */
extern void FP_mod(B512_56::BIG r, B512_56::DBIG d);

#ifdef FUSED_MODMUL
extern void FP_modmul(B512_56::BIG, B512_56::BIG, B512_56::BIG);
#endif
 ...
 */
extern void FP_pow(FP *x, FP *y, B512_56::BIG z);
