...
#define MODBITS_C1665 MBITS_C1665
#define TBITS_C1665 (MBITS_C1665%BASEBITS_B168_60)              /**< Number of active bits in top word */
#define TMASK_C1665 (((chunk)1<<TBITS_C1665)-1)             /**< Mask for active bits in top word */
#define FEXCESS_C1665 (((sign32)1<<MAXXES_C1665)-1)		    /**< 2^(BASEBITS*NLEN-MODBITS) - normalised BIG can be multiplied by less than this before reduction */
#define OMASK_C1665 (-((chunk)(1)<<TBITS_C1665))            /**<  for masking out overflow bits */
...
typedef struct
{
    B168_60::BIG g;	/**< Big representation of field element */
    sign32 XES;	/**< Excess */
} FP;

/* Field Params - see rom.c */
extern const B168_60::BIG Modulus;	/**< Actual Modulus set in rom_field*.c */
extern const B168_60::BIG ROI;	    /**< Root of Unity  set in rom_field*.c */
extern const B168_60::BIG R2modp;	/**< Montgomery constant */
...
extern const B168_60::BIG Fra; /**< real part of Pairing-friendly curve Frobenius Constant */
extern const B168_60::BIG Frb; /**< imaginary part of Pairing-friendly curve Frobenius Constant */
 ...
 */
extern void FP_rcopy(FP *y, const B168_60::BIG x);
 ...
 */
extern void FP_mod(B168_60::BIG r, B168_60::DBIG d);

#ifdef FUSED_MODMUL
extern void FP_modmul(B168_60::BIG, B168_60::BIG, B168_60::BIG);
#endif
 ...
 */
extern void FP_pow(FP *x, FP *y, B168_60::BIG z);
