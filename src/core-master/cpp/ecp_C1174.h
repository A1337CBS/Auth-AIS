...
//    int inf; /**< Infinity Flag - not needed for Edwards representation */
    ...
    C1174::FP x; /**< x-coordinate of point */
#if CURVETYPE_C1174!=MONTGOMERY
    C1174::FP y; /**< y-coordinate of point. Not needed for Montgomery representation */
#endif
    C1174::FP z;/**< z-coordinate of point */
} ECP;
 ...
 */
extern void ECP_rhs(C1174::FP *r, C1174::FP *x);
