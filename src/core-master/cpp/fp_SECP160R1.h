...
#ifndef FP_SECP160R1_H
#define FP_SECP160R1_H
...
#define MODBITS_SECP160R1 MBITS_SECP160R1
#define TBITS_SECP160R1 (MBITS_SECP160R1%BASEBITS_B160_56)              /**< Number of active bits in top word */
#define TMASK_SECP160R1 (((chunk)1<<TBITS_SECP160R1)-1)             /**< Mask for active bits in top word */
#define FEXCESS_SECP160R1 (((sign32)1<<MAXXES_SECP160R1)-1)		    /**< 2^(BASEBITS*NLEN-MODBITS) - normalised BIG can be multiplied by less than this before reduction */
#define OMASK_SECP160R1 (-((chunk)(1)<<TBITS_SECP160R1))            /**<  for masking out overflow bits */
...
typedef struct
{
    B160_56::BIG g;	/**< Big representation of field element */
    sign32 XES;	/**< Excess */
} FP;

/* Field Params - see rom.c */
extern const B160_56::BIG Modulus;	/**< Actual Modulus set in rom_field*.c */
extern const B160_56::BIG ROI;	    /**< Root of Unity  set in rom_field*.c */
extern const B160_56::BIG R2modp;	/**< Montgomery constant */
...
extern const B160_56::BIG Fra; /**< real part of Pairing-friendly curve Frobenius Constant */
extern const B160_56::BIG Frb; /**< imaginary part of Pairing-friendly curve Frobenius Constant */
 ...
 */
extern void FP_rcopy(FP *y, const B160_56::BIG x);
 ...
 */
extern void FP_mod(B160_56::BIG r, B160_56::DBIG d);

#ifdef FUSED_MODMUL
extern void FP_modmul(B160_56::BIG, B160_56::BIG, B160_56::BIG);
#endif
 ...
 */
extern void FP_pow(FP *x, FP *y, B160_56::BIG z);
