...
#define MODBITS_F256PMW MBITS_F256PMW
#define TBITS_F256PMW (MBITS_F256PMW%BASEBITS_B256_56)              /**< Number of active bits in top word */
#define TMASK_F256PMW (((chunk)1<<TBITS_F256PMW)-1)             /**< Mask for active bits in top word */
#define FEXCESS_F256PMW (((sign32)1<<MAXXES_F256PMW)-1)		    /**< 2^(BASEBITS*NLEN-MODBITS) - normalised BIG can be multiplied by less than this before reduction */
#define OMASK_F256PMW (-((chunk)(1)<<TBITS_F256PMW))            /**<  for masking out overflow bits */
