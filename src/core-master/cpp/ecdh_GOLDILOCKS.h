...
#ifndef ECDH_GOLDILOCKS_H
#define ECDH_GOLDILOCKS_H
...
#define EGS_GOLDILOCKS MODBYTES_B448_58  /**< ECC Group Size in bytes */
#define EFS_GOLDILOCKS MODBYTES_B448_58  /**< ECC Field Size in bytes */
