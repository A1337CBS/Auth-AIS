...
#ifndef BIG_B448_58_H
#define BIG_B448_58_H
...
#define BIGBITS_B448_58 (8*MODBYTES_B448_58)
#define NLEN_B448_58 (1+((8*MODBYTES_B448_58-1)/BASEBITS_B448_58))
#define DNLEN_B448_58 2*NLEN_B448_58
#define BMASK_B448_58 (((chunk)1<<BASEBITS_B448_58)-1) /**< Mask = 2^BASEBITS-1 */
#define NEXCESS_B448_58 (1<<(CHUNK-BASEBITS_B448_58-1))           /**< 2^(CHUNK-BASEBITS-1) - digit cannot be multiplied by more than this before normalisation */

#define HBITS_B448_58 (BASEBITS_B448_58/2)      /**< Number of bits in number base divided by 2 */
#define HMASK_B448_58 (((chunk)1<<HBITS_B448_58)-1)    /**< Mask = 2^HBITS-1 */

//#define DEBUG_NORM

#ifdef DEBUG_NORM  /* Add an extra location to track chunk extension */
#define MPV_B448_58 NLEN_B448_58
#define MNV_B448_58 (NLEN_B448_58+1)
#define DMPV_B448_58 DNLEN_B448_58
#define DMNV_B448_58 (DNLEN_B448_58+1)
...
#ifdef DEBUG_NORM
typedef chunk BIG[NLEN_B448_58 + 2]; /**< Define type BIG as array of chunks */
typedef chunk DBIG[DNLEN_B448_58 + 2]; /**< Define type DBIG as array of chunks */
#else
typedef chunk BIG[NLEN_B448_58];     /**< Define type BIG as array of chunks */
typedef chunk DBIG[DNLEN_B448_58];   /**< Define type DBIG as array of chunks */
#endif
...
inline chunk muladd(chunk x, chunk y, chunk c, chunk *r)
{
    ...
    *r = (chunk)prod & BMASK_B448_58;
    return (chunk)(prod >> BASEBITS_B448_58);
}
...
inline chunk muladd(chunk x, chunk y, chunk c, chunk *r)
{
    ...
    top = x1 * y1;
    mid = x0 * y1 + x1 * y0;
    x0 = mid & HMASK_B448_58;
    x1 = (mid >> HBITS_B448_58);
    bot += x0 << HBITS_B448_58;
    bot += *r;
    bot += c;

    top += x1;
    carry = bot >> BASEBITS_B448_58;
    bot &= BMASK_B448_58;
    top += carry;
