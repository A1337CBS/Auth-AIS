...
#ifndef ECDH_JUBJUB_H
#define ECDH_JUBJUB_H
...
#define EGS_JUBJUB MODBYTES_B256_56  /**< ECC Group Size in bytes */
#define EFS_JUBJUB MODBYTES_B256_56  /**< ECC Field Size in bytes */
