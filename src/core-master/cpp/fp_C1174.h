...
#define MODBITS_C1174 MBITS_C1174
#define TBITS_C1174 (MBITS_C1174%BASEBITS_B256_56)              /**< Number of active bits in top word */
#define TMASK_C1174 (((chunk)1<<TBITS_C1174)-1)             /**< Mask for active bits in top word */
#define FEXCESS_C1174 (((sign32)1<<MAXXES_C1174)-1)		    /**< 2^(BASEBITS*NLEN-MODBITS) - normalised BIG can be multiplied by less than this before reduction */
#define OMASK_C1174 (-((chunk)(1)<<TBITS_C1174))            /**<  for masking out overflow bits */
