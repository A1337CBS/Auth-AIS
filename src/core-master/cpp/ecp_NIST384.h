...
#ifndef ECP_NIST384_H
#define ECP_NIST384_H

#include "fp_NIST384.h"
#include "config_curve_NIST384.h"
...
//    int inf; /**< Infinity Flag - not needed for Edwards representation */
    ...
    NIST384::FP x; /**< x-coordinate of point */
#if CURVETYPE_NIST384!=MONTGOMERY
    NIST384::FP y; /**< y-coordinate of point. Not needed for Montgomery representation */
#endif
    NIST384::FP z;/**< z-coordinate of point */
} ECP;
 ...
 */
extern void ECP_rhs(NIST384::FP *r, NIST384::FP *x);
