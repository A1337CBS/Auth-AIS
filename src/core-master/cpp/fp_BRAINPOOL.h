...
#define MODBITS_BRAINPOOL MBITS_BRAINPOOL
#define TBITS_BRAINPOOL (MBITS_BRAINPOOL%BASEBITS_B256_56)              /**< Number of active bits in top word */
#define TMASK_BRAINPOOL (((chunk)1<<TBITS_BRAINPOOL)-1)             /**< Mask for active bits in top word */
#define FEXCESS_BRAINPOOL (((sign32)1<<MAXXES_BRAINPOOL)-1)		    /**< 2^(BASEBITS*NLEN-MODBITS) - normalised BIG can be multiplied by less than this before reduction */
