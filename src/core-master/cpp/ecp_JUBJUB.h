...
//    int inf; /**< Infinity Flag - not needed for Edwards representation */
    ...
    JUBJUB::FP x; /**< x-coordinate of point */
#if CURVETYPE_JUBJUB!=MONTGOMERY
    JUBJUB::FP y; /**< y-coordinate of point. Not needed for Montgomery representation */
#endif
    JUBJUB::FP z;/**< z-coordinate of point */
} ECP;
 ...
 */
extern void ECP_rhs(JUBJUB::FP *r, JUBJUB::FP *x);
