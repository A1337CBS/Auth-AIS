...
#ifndef ECDH_HIFIVE_H
#define ECDH_HIFIVE_H
...
#define EGS_HIFIVE MODBYTES_B336_60  /**< ECC Group Size in bytes */
#define EFS_HIFIVE MODBYTES_B336_60  /**< ECC Field Size in bytes */
