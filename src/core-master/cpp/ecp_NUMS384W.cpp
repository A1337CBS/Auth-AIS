...
int NUMS384W::ECP_isinf(ECP *P)
{

#if CURVETYPE_NUMS384W==EDWARDS
    return (FP_iszilch(&(P->x)) && FP_equals(&(P->y), &(P->z)));
#endif
#if CURVETYPE_NUMS384W==WEIERSTRASS
...
static void ECP_cswap(NUMS384W::ECP *P, NUMS384W::ECP *Q, int d)
{
    FP_cswap(&(P->x), &(Q->x), d);
#if CURVETYPE_NUMS384W!=MONTGOMERY
    FP_cswap(&(P->y), &(Q->y), d);
...
static void ECP_cmove(NUMS384W::ECP *P, NUMS384W::ECP *Q, int d)
{
    FP_cmove(&(P->x), &(Q->x), d);
#if CURVETYPE_NUMS384W!=MONTGOMERY
    FP_cmove(&(P->y), &(Q->y), d);
...
#endif // CURVETYPE_NUMS384W!=MONTGOMERY

#if CURVETYPE_NUMS384W!=MONTGOMERY
/* Constant time select from pre-computed table */
static void ECP_select(NUMS384W::ECP *P, NUMS384W::ECP W[], sign32 b)
{
    NUMS384W::ECP MP;
    sign32 m = b >> 31;
    sign32 babs = (b ^ m) - m;
...
/* Test P == Q */
/* SU=168 */
int NUMS384W::ECP_equals(ECP *P, ECP *Q)
{
    FP a, b;
...
/* Set P=Q */
/* SU=16 */
void NUMS384W::ECP_copy(ECP *P, ECP *Q)
{
    FP_copy(&(P->x), &(Q->x));
#if CURVETYPE_NUMS384W!=MONTGOMERY
    FP_copy(&(P->y), &(Q->y));
...
/* SU=56 */
void NUMS384W::ECP_rhs(FP *v, FP *x)
{
#if CURVETYPE_NUMS384W==WEIERSTRASS
    /* x^3+Ax+B */
    FP t;
...
int NUMS384W::ECP_set(ECP *P, BIG x)
{
    FP rhs;
    FP_nres(&rhs, x);
...
int NUMS384W::ECP_get(BIG x, ECP *P)
{
    ECP W;
    ECP_copy(&W, P);
    ECP_affine(&W);
...
/* SU=16 */
int NUMS384W::ECP_get(BIG x, BIG y, ECP *P)
{
    int s;
    ECP W;
    ECP_copy(&W, P);
...
/* Set P=(x,{y}) */
/* SU=96 */
int NUMS384W::ECP_set(ECP *P, BIG x, BIG y)
{
    FP rhs, y2;
...
/* SU=136 */
int NUMS384W::ECP_setx(ECP *P, BIG x, int s)
{
    FP rhs,hint;
    BIG t;
...
/* SU=160 */
void NUMS384W::ECP_affine(ECP *P)
{
    FP one, iz;
...
#if CURVETYPE_NUMS384W==EDWARDS || CURVETYPE_NUMS384W==WEIERSTRASS
...
/* SU=120 */
void NUMS384W::ECP_outputxyz(ECP *P)
{
    BIG x, z;
    if (ECP_isinf(P))
    {
...
/* SU=16 */
/* Output point P */
void NUMS384W::ECP_output(ECP *P)
{
    BIG x, y;
    if (ECP_isinf(P))
    {
...
/* SU=16 */
/* Output point P */
void NUMS384W::ECP_rawoutput(ECP *P)
{
    BIG x, y, z;
...
void NUMS384W::ECP_toOctet(octet *W, ECP *P, bool compress)
{
#if CURVETYPE_NUMS384W==MONTGOMERY
    BIG x;
    ECP_get(x, P);
...
int NUMS384W::ECP_fromOctet(ECP *P, octet *W)
{
#if CURVETYPE_NUMS384W==MONTGOMERY
    BIG x;
...
void NUMS384W::ECP_add(ECP *P, ECP *Q, ECP *W)
{
    FP A, B, C, D, DA, CB;
...
/* Set P+=Q */
/* SU=248 */
void NUMS384W::ECP_add(ECP *P, ECP *Q)
{
#if CURVETYPE_NUMS384W==WEIERSTRASS
...
/* Set P-=Q */
/* SU=16 */
void  NUMS384W::ECP_sub(ECP *P, ECP *Q)
{
    ECP NQ;
    ECP_copy(&NQ, Q);
    ECP_neg(&NQ);
...
void NUMS384W::ECP_pinmul(ECP *P, int e, int bts)
{
    int i, b;
    ECP R0, R1;
...
/* Set P=r*P */
/* SU=424 */
void NUMS384W::ECP_mul(ECP *P, BIG e)
{
#if CURVETYPE_NUMS384W==MONTGOMERY
    /* Montgomery ladder */
    int nb, i, b;
...
void NUMS384W::ECP_mul2(ECP *P, ECP *Q, BIG e, BIG f)
{
    BIG te, tf, mt;
    ECP S, T, W[8], C;
...
void NUMS384W::ECP_hashit(ECP *P,BIG h)
{
#if CURVETYPE_NUMS384W==MONTGOMERY
// Elligator 2
    BIG a;
...
void NUMS384W::ECP_mapit(ECP *P, octet *W)
{
    BIG q, x;
    DBIG dx;
    BIG_rcopy(q, Modulus);
...
int NUMS384W::ECP_generator(ECP *G)
{
    BIG x, y;
