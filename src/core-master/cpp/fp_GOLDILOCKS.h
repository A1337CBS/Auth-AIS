...
#define TBITS_GOLDILOCKS (MBITS_GOLDILOCKS%BASEBITS_B448_58)              /**< Number of active bits in top word */
#define TMASK_GOLDILOCKS (((chunk)1<<TBITS_GOLDILOCKS)-1)             /**< Mask for active bits in top word */
#define FEXCESS_GOLDILOCKS (((sign32)1<<MAXXES_GOLDILOCKS)-1)		    /**< 2^(BASEBITS*NLEN-MODBITS) - normalised BIG can be multiplied by less than this before reduction */
#define OMASK_GOLDILOCKS (-((chunk)(1)<<TBITS_GOLDILOCKS))            /**<  for masking out overflow bits */
...
typedef struct
{
    B448_58::BIG g;	/**< Big representation of field element */
    sign32 XES;	/**< Excess */
} FP;

/* Field Params - see rom.c */
extern const B448_58::BIG Modulus;	/**< Actual Modulus set in rom_field*.c */
extern const B448_58::BIG ROI;	    /**< Root of Unity  set in rom_field*.c */
extern const B448_58::BIG R2modp;	/**< Montgomery constant */
...
extern const B448_58::BIG Fra; /**< real part of Pairing-friendly curve Frobenius Constant */
extern const B448_58::BIG Frb; /**< imaginary part of Pairing-friendly curve Frobenius Constant */
 ...
 */
extern void FP_rcopy(FP *y, const B448_58::BIG x);
 ...
 */
extern void FP_mod(B448_58::BIG r, B448_58::DBIG d);

#ifdef FUSED_MODMUL
extern void FP_modmul(B448_58::BIG, B448_58::BIG, B448_58::BIG);
#endif
 ...
 */
extern void FP_pow(FP *x, FP *y, B448_58::BIG z);
