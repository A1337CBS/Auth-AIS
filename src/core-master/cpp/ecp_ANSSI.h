...
//    int inf; /**< Infinity Flag - not needed for Edwards representation */
    ...
    ANSSI::FP x; /**< x-coordinate of point */
#if CURVETYPE_ANSSI!=MONTGOMERY
    ANSSI::FP y; /**< y-coordinate of point. Not needed for Montgomery representation */
#endif
    ANSSI::FP z;/**< z-coordinate of point */
} ECP;
 ...
 */
extern void ECP_rhs(ANSSI::FP *r, ANSSI::FP *x);
