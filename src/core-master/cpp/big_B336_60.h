...
#ifndef BIG_B336_60_H
#define BIG_B336_60_H
...
#define BIGBITS_B336_60 (8*MODBYTES_B336_60)
#define NLEN_B336_60 (1+((8*MODBYTES_B336_60-1)/BASEBITS_B336_60))
#define DNLEN_B336_60 2*NLEN_B336_60
#define BMASK_B336_60 (((chunk)1<<BASEBITS_B336_60)-1) /**< Mask = 2^BASEBITS-1 */
#define NEXCESS_B336_60 (1<<(CHUNK-BASEBITS_B336_60-1))           /**< 2^(CHUNK-BASEBITS-1) - digit cannot be multiplied by more than this before normalisation */

#define HBITS_B336_60 (BASEBITS_B336_60/2)      /**< Number of bits in number base divided by 2 */
#define HMASK_B336_60 (((chunk)1<<HBITS_B336_60)-1)    /**< Mask = 2^HBITS-1 */

//#define DEBUG_NORM

#ifdef DEBUG_NORM  /* Add an extra location to track chunk extension */
#define MPV_B336_60 NLEN_B336_60
#define MNV_B336_60 (NLEN_B336_60+1)
#define DMPV_B336_60 DNLEN_B336_60
#define DMNV_B336_60 (DNLEN_B336_60+1)
...
#ifdef DEBUG_NORM
typedef chunk BIG[NLEN_B336_60 + 2]; /**< Define type BIG as array of chunks */
typedef chunk DBIG[DNLEN_B336_60 + 2]; /**< Define type DBIG as array of chunks */
#else
typedef chunk BIG[NLEN_B336_60];     /**< Define type BIG as array of chunks */
typedef chunk DBIG[DNLEN_B336_60];   /**< Define type DBIG as array of chunks */
#endif
...
inline chunk muladd(chunk x, chunk y, chunk c, chunk *r)
{
    ...
    top = x1 * y1;
    mid = x0 * y1 + x1 * y0;
    x0 = mid & HMASK_B336_60;
    x1 = (mid >> HBITS_B336_60);
    bot += x0 << HBITS_B336_60;
    bot += *r;
    bot += c;

    top += x1;
    carry = bot >> BASEBITS_B336_60;
    bot &= BMASK_B336_60;
    top += carry;
