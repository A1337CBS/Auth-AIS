...
#define MODBITS_F25519 MBITS_F25519
#define TBITS_F25519 (MBITS_F25519%BASEBITS_B256_56)              /**< Number of active bits in top word */
#define TMASK_F25519 (((chunk)1<<TBITS_F25519)-1)             /**< Mask for active bits in top word */
#define FEXCESS_F25519 (((sign32)1<<MAXXES_F25519)-1)		    /**< 2^(BASEBITS*NLEN-MODBITS) - normalised BIG can be multiplied by less than this before reduction */
