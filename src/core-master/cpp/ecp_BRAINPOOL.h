...
//    int inf; /**< Infinity Flag - not needed for Edwards representation */
    ...
    BRAINPOOL::FP x; /**< x-coordinate of point */
#if CURVETYPE_BRAINPOOL!=MONTGOMERY
    BRAINPOOL::FP y; /**< y-coordinate of point. Not needed for Montgomery representation */
#endif
    BRAINPOOL::FP z;/**< z-coordinate of point */
} ECP;
 ...
 */
extern void ECP_rhs(BRAINPOOL::FP *r, BRAINPOOL::FP *x);
