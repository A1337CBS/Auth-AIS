...
#ifndef ECP_NUMS256E_H
#define ECP_NUMS256E_H

#include "fp_F256PME.h"
#include "config_curve_NUMS256E.h"
...
//    int inf; /**< Infinity Flag - not needed for Edwards representation */
    ...
    F256PME::FP x; /**< x-coordinate of point */
#if CURVETYPE_NUMS256E!=MONTGOMERY
    F256PME::FP y; /**< y-coordinate of point. Not needed for Montgomery representation */
#endif
    F256PME::FP z;/**< z-coordinate of point */
} ECP;
 ...
 */
extern void ECP_rhs(F256PME::FP *r, F256PME::FP *x);
