...
#define MODBITS_SM2 MBITS_SM2
#define TBITS_SM2 (MBITS_SM2%BASEBITS_B256_56)              /**< Number of active bits in top word */
#define TMASK_SM2 (((chunk)1<<TBITS_SM2)-1)             /**< Mask for active bits in top word */
#define FEXCESS_SM2 (((sign32)1<<MAXXES_SM2)-1)		    /**< 2^(BASEBITS*NLEN-MODBITS) - normalised BIG can be multiplied by less than this before reduction */
#define OMASK_SM2 (-((chunk)(1)<<TBITS_SM2))            /**<  for masking out overflow bits */
