...
using namespace C1174;

/* test for P=O point-at-infinity */
int C1174::ECP_isinf(ECP *P)
{

#if CURVETYPE_C1174==EDWARDS
    return (FP_iszilch(&(P->x)) && FP_equals(&(P->y), &(P->z)));
#endif
#if CURVETYPE_C1174==WEIERSTRASS
    return (FP_iszilch(&(P->x)) && FP_iszilch(&(P->z)));
#endif
#if CURVETYPE_C1174==MONTGOMERY
...
static void ECP_cswap(C1174::ECP *P, C1174::ECP *Q, int d)
{
    FP_cswap(&(P->x), &(Q->x), d);
#if CURVETYPE_C1174!=MONTGOMERY
    FP_cswap(&(P->y), &(Q->y), d);
...
static void ECP_cmove(C1174::ECP *P, C1174::ECP *Q, int d)
{
    FP_cmove(&(P->x), &(Q->x), d);
#if CURVETYPE_C1174!=MONTGOMERY
    FP_cmove(&(P->y), &(Q->y), d);
...
#endif // CURVETYPE_C1174!=MONTGOMERY

#if CURVETYPE_C1174!=MONTGOMERY
/* Constant time select from pre-computed table */
static void ECP_select(C1174::ECP *P, C1174::ECP W[], sign32 b)
{
    C1174::ECP MP;
    sign32 m = b >> 31;
    sign32 babs = (b ^ m) - m;
...
/* Test P == Q */
/* SU=168 */
int C1174::ECP_equals(ECP *P, ECP *Q)
{
    FP a, b;
...
/* Set P=Q */
/* SU=16 */
void C1174::ECP_copy(ECP *P, ECP *Q)
{
    FP_copy(&(P->x), &(Q->x));
#if CURVETYPE_C1174!=MONTGOMERY
    FP_copy(&(P->y), &(Q->y));
...
/* SU=16 */
int C1174::ECP_get(BIG x, BIG y, ECP *P)
{
    int s;
    ECP W;
    ECP_copy(&W, P);
...
/* Set P=(x,{y}) */
/* SU=96 */
int C1174::ECP_set(ECP *P, BIG x, BIG y)
{
    FP rhs, y2;
...
/* SU=136 */
int C1174::ECP_setx(ECP *P, BIG x, int s)
{
    FP rhs,hint;
    BIG t;
...
#if CURVETYPE_C1174==EDWARDS || CURVETYPE_C1174==WEIERSTRASS
...
/* SU=120 */
void C1174::ECP_outputxyz(ECP *P)
{
    BIG x, z;
    if (ECP_isinf(P))
    {
...
/* SU=16 */
/* Output point P */
void C1174::ECP_rawoutput(ECP *P)
{
    BIG x, y, z;
...
void C1174::ECP_toOctet(octet *W, ECP *P, bool compress)
{
#if CURVETYPE_C1174==MONTGOMERY
    BIG x;
    ECP_get(x, P);
...
int C1174::ECP_fromOctet(ECP *P, octet *W)
{
#if CURVETYPE_C1174==MONTGOMERY
    BIG x;
...
void C1174::ECP_add(ECP *P, ECP *Q, ECP *W)
{
    FP A, B, C, D, DA, CB;
...
/* Set P+=Q */
/* SU=248 */
void C1174::ECP_add(ECP *P, ECP *Q)
{
#if CURVETYPE_C1174==WEIERSTRASS
...
/* Set P-=Q */
/* SU=16 */
void  C1174::ECP_sub(ECP *P, ECP *Q)
{
    ECP NQ;
    ECP_copy(&NQ, Q);
    ECP_neg(&NQ);
...
void C1174::ECP_pinmul(ECP *P, int e, int bts)
{
    int i, b;
    ECP R0, R1;
...
/* Set P=r*P */
/* SU=424 */
void C1174::ECP_mul(ECP *P, BIG e)
{
#if CURVETYPE_C1174==MONTGOMERY
    /* Montgomery ladder */
    int nb, i, b;
...
void C1174::ECP_mul2(ECP *P, ECP *Q, BIG e, BIG f)
{
    BIG te, tf, mt;
    ECP S, T, W[8], C;
...
void C1174::ECP_hashit(ECP *P,BIG h)
{
#if CURVETYPE_C1174==MONTGOMERY
// Elligator 2
    BIG a;
    ...
    if (PM1D2_C1174 == 1)
        FP_neg(&t,&t);      // -t^2
    if (PM1D2_C1174 > 2)
        FP_imul(&t,&t,QNRI_C1174); // precomputed QNR
...
void C1174::ECP_mapit(ECP *P, octet *W)
{
    BIG q, x;
    DBIG dx;
    BIG_rcopy(q, Modulus);
