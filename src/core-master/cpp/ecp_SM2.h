...
//    int inf; /**< Infinity Flag - not needed for Edwards representation */
    ...
    SM2::FP x; /**< x-coordinate of point */
#if CURVETYPE_SM2!=MONTGOMERY
    SM2::FP y; /**< y-coordinate of point. Not needed for Montgomery representation */
#endif
    SM2::FP z;/**< z-coordinate of point */
} ECP;
 ...
 */
extern void ECP_rhs(SM2::FP *r, SM2::FP *x);
