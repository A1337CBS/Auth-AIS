...
#define MODBITS_F256PME MBITS_F256PME
#define TBITS_F256PME (MBITS_F256PME%BASEBITS_B256_56)              /**< Number of active bits in top word */
#define TMASK_F256PME (((chunk)1<<TBITS_F256PME)-1)             /**< Mask for active bits in top word */
#define FEXCESS_F256PME (((sign32)1<<MAXXES_F256PME)-1)		    /**< 2^(BASEBITS*NLEN-MODBITS) - normalised BIG can be multiplied by less than this before reduction */
#define OMASK_F256PME (-((chunk)(1)<<TBITS_F256PME))            /**<  for masking out overflow bits */
