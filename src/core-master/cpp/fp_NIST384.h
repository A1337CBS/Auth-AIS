...
#define MODBITS_NIST384 MBITS_NIST384
#define TBITS_NIST384 (MBITS_NIST384%BASEBITS_B384_56)              /**< Number of active bits in top word */
#define TMASK_NIST384 (((chunk)1<<TBITS_NIST384)-1)             /**< Mask for active bits in top word */
#define FEXCESS_NIST384 (((sign32)1<<MAXXES_NIST384)-1)		    /**< 2^(BASEBITS*NLEN-MODBITS) - normalised BIG can be multiplied by less than this before reduction */
#define OMASK_NIST384 (-((chunk)(1)<<TBITS_NIST384))            /**<  for masking out overflow bits */
...
typedef struct
{
    B384_56::BIG g;	/**< Big representation of field element */
    sign32 XES;	/**< Excess */
} FP;

/* Field Params - see rom.c */
extern const B384_56::BIG Modulus;	/**< Actual Modulus set in rom_field*.c */
extern const B384_56::BIG ROI;	    /**< Root of Unity  set in rom_field*.c */
extern const B384_56::BIG R2modp;	/**< Montgomery constant */
...
extern const B384_56::BIG Fra; /**< real part of Pairing-friendly curve Frobenius Constant */
extern const B384_56::BIG Frb; /**< imaginary part of Pairing-friendly curve Frobenius Constant */
 ...
 */
extern void FP_rcopy(FP *y, const B384_56::BIG x);
 ...
 */
extern void FP_mod(B384_56::BIG r, B384_56::DBIG d);

#ifdef FUSED_MODMUL
extern void FP_modmul(B384_56::BIG, B384_56::BIG, B384_56::BIG);
#endif
 ...
 */
extern void FP_pow(FP *x, FP *y, B384_56::BIG z);
